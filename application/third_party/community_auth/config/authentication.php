...
$config['groups'] = array(
	'employees' => 'agent,super-agent,admin'
);
...
$config['remember_me_cookie_name'] = 'PMSrememberMe';
...
$config['http_user_cookie_name'] = 'PMShttpUser';
...
$config['http_tokens_cookie']  = 'PMShttpTokens';
$config['https_tokens_cookie'] = 'PMShttpsTokens';
$config['token_jar_size']      = 32;
$config['token_name']          = 'PMStoken';
